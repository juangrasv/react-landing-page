        ...
        <div className="relative flex h-16 items-center justify-between">
          <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
            ...
            <DisclosureButton className="group inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
              ...
              <Bars3Icon aria-hidden="true" className="block h-12 w-6 group-data-[open]:hidden" />
              <XMarkIcon aria-hidden="true" className="hidden h-12 w-6 group-data-[open]:block" />
            </DisclosureButton>
          </div>
                ...
                {navigation.map((item) => (
                  <a
                    ...
                    className={classNames(
                      item.current ? 'bg-blue-900 text-white' : 'text-white-300 hover:bg-gray-700 hover:text-white',
